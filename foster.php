...
<body>
    <div class="dashboard-container io">
        <div class="main-content" style="padding:2em" id="mainContent">
            <div class="container" style="width:80%;margin:auto">
                ...
                <form id="fosterForm" action="./controllers/ApplicationsController.php" method="POST">
                    ...
                    <button onclick="window.location.href='my_applications.php'">See applications</button>
                </form>
            </div>
        </div>
    </div>
