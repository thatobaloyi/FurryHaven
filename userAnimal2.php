...
<head>
  ...
  <style>
    ...
    /* New style for button container and back button */
    .button-container {
      display: flex;
    ...
    #backButton {
      background-color: #003366; /* New color for the back button */
    }
...
<body>
  ...
  <form id="volunteerForm" action="./controllers/ApplicationsController.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="button-container">
      <!-- Back Button -->
      <button type="button" id="backButton" onclick="window.history.back()">⬅️ Back</button>
      <!-- Submit Button -->
